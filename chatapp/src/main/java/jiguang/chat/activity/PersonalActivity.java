    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == JGApplication.TAKE_PHOTO_MESSAGE) {
            if (grantResults[0] != PackageManager.PERMISSION_GRANTED) {
                Toast.makeText(PersonalActivity.this, "请在应用管理中打开“相机”访问权限！", Toast.LENGTH_SHORT).show();
            } else {
                if (grantResults[1] != PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(PersonalActivity.this, "请在应用管理中打开“读写存储”访问权限！", Toast.LENGTH_SHORT).show();
                } else {
...
//                    Toast.makeText(PersonalActivity.this, "请在应用管理中打开“读写存储”和“相机”访问权限！", Toast.LENGTH_SHORT).show();
                    ...
                    ActivityCompat.requestPermissions(this, new String[]{Manifest.permission.CAMERA, Manifest.permission.READ_EXTERNAL_STORAGE}, JGApplication.TAKE_PHOTO_MESSAGE);
